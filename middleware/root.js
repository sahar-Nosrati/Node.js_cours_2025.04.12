...
route.get("/haftsin/Samanou(.html)?", (req, res) => {
  res.sendFile(
    path.join(__dirname, "..", "views", "Haftsin", "samanou.html")
  );
});
route.get("/haftsin/Sabzeh(.html)?", (req, res) => {
  res.sendFile(
    path.join(__dirname, "..", "views", "Haftsin", "sabzeh.html")
  );
});
route.get("/haftsin/Sekeh(.html)?", (req, res) => {
  res.sendFile(
    path.join(__dirname, "..", "views", "Haftsin", "sekeh.html")
  );
});
route.get("/haftsin/Senjed(.html)?", (req, res) => {
  res.sendFile(
    path.join(__dirname, "..", "views", "Haftsin", "senjed.html")
  );
});
route.get("/haftsin/Serkeh(.html)?", (req, res) => {
  res.sendFile(
    path.join(__dirname, "..", "views", "Haftsin", "serkeh.html")
  );
});
route.get("/haftsin/sib(.html)?", (req, res) => {
  res.sendFile(
    path.join(__dirname, "..", "views", "Haftsin", "sib.html")
  );
});
route.get("/haftsin/sir(.html)?", (req, res) => {
  res.sendFile(
    path.join(__dirname, "..", "views", "Haftsin", "sir.html")
  );
});
